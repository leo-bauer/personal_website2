...
* [Converting SRDP Faction IDs to UCDP Actor IDs](/conversion)

This dataset contains all SRDP faction IDs that match a UCDP actor ID and can thus be used to merge the SRDP with UCDP data.
