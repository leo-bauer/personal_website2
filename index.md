...
At UMD I am a member of the [Interdisciplinary Laboratory of Computational Social Science](https://ilcss.umd.edu/){:target="_blank"}{:rel="noopener noreferrer"}. My enthusiasm for computational social science has led to several projects that lie apart from my research agenda on intrastate conflict. These projects center on media politics and secret police informant recruitment in autocracies and employ custom webscrapers, named entity recognition, sentiment analysis and classification with large-language models for data generation and analysis. 
